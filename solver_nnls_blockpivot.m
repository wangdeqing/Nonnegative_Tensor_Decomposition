...
function [ X,Y,success,numChol,numEq,bigIter ] = solver_nnls_blockpivot( A, B, isInputProd, maxiter, init )
    ...
    if nargin<4, MAX_BIG_ITER = 5; else, MAX_BIG_ITER = maxiter; end
